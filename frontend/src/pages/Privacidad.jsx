                ...
                <div className="max-w-4xl mx-auto bg-stone-700 p-8 rounded-lg shadow-lg">
                    ...
                    <section className="mb-8">
                        ...
                        <ul className="list-disc list-inside mt-2">
                            ...
                            <li><strong>Cookies:</strong> Información de navegación (ver nuestra <a href="/politica-de-cookies" className="text-[#b4ab9c] hover:underline">Política de Cookies</a>).</li>
                        </ul>
                    </section>
                    ...
                    <section className="mb-8">
                        ...
                        <p className="mt-2">
                            Para ejercer estos derechos, el usuario puede enviar un correo a <a href="mailto:stellarprogresscompany@gmail.com" className="text-[#b4ab9c] hover:underline">stellarprogresscompany@gmail.com</a>.
                        </p>
                    </section>
                    ...
                    <section className="mb-8">
                        ...
                        <p className="text-[#b4ab9c]">📧 stellarprogresscompany@gmail.com</p>
                    </section>
                </div>
            </main>
            <Footer />
